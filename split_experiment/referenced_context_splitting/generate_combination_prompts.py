...
from config.paths import REFERENCED_CONTEXT_SPLITTING_PARTIAL_FSMS_DIR, REFERENCED_CONTEXT_SPLITTING_PROMPTS_DIR
...
# generate all referenced context combination Prompts.
def generate_combination_prompts() -> dict[str, str]:
    partial_fsms_files: list[Path] = sorted(REFERENCED_CONTEXT_SPLITTING_PARTIAL_FSMS_DIR.glob("*_partial_fsms.json"))
    ...
    output_file: Path = REFERENCED_CONTEXT_SPLITTING_PROMPTS_DIR / "combination_prompts.json"
