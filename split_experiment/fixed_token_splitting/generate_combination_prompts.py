...
from config.paths import FIXED_TOKEN_SPLITTING_PARTIAL_FSMS_DIR, FIXED_TOKEN_SPLITTING_PROMPTS_DIR
...
# generate all fixed token combination Prompts.
def generate_combination_prompts() -> dict[str, str]:
    partial_fsms_files: list[Path] = sorted(FIXED_TOKEN_SPLITTING_PARTIAL_FSMS_DIR.glob("*_partial_fsms.json"))
    ...
    output_file: Path = FIXED_TOKEN_SPLITTING_PROMPTS_DIR / "combination_prompts.json"
